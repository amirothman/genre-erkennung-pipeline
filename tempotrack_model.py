...
def tempotrack_model(input_shape):
    nb_filter = 100
    filter_length = 50
    hidden_dims = 250
...
if __name__ == "__main__":
    batch_size = 20
    nb_epoch = 200
    X = pickle.load(open("3_genres_tempotracker_tempo_training_vector.pickle","rb"))
    y = pickle.load(open("3_genres_tempotracker_tempo_label.pickle","rb"))

    X_test = pickle.load(open("3_genres_tempotracker_tempo_evaluation_training_vector.pickle","rb"))
    y_test = pickle.load(open("3_genres_tempotracker_tempo_evaluation_label.pickle","rb"))
    ...
    model = tempotrack_model(((X.shape[1],X.shape[2])))
