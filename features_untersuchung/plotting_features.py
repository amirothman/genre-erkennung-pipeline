...
for jdx in range(num_plots):
    ...
    for genre in genres:
        ...
        # csv_path = "../dataset/gztan/test/{0}/{0}.000{1}{2}_vamp_mtg-melodia_melodia_melody.csv".format(genre,rand_num_1,rand_num_2)
    ...
    for idx,ax in enumerate(axarr):
        ...
        value = csv_list[idx][:,1]
        if idx is 0 and jdx is 0:
            print(value)
            print(time_array)
        axarr[idx][jdx].plot(time_array,value,"b",alpha=0.9,ms=0.7)
